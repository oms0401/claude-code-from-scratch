...
class CLI:
    ...
    async def run_interactive(self) -> str | None:
        ...
        async with Agent(
            ...
            while True:
                try:
                    user_input = console.input("\n[dim]  ›[/dim] [user]You[/user] [dim]›[/dim] ").strip()
                    if not user_input:
                        continue
                    ...
                    console.print("\n[dim]Use /exit to quit Om's Den.[/dim]")
                except EOFError:
                    break

        console.print()
        console.print("[dim]  · · ·  [/dim][muted]Thanks for using Om's Den — see you next time.[/muted][dim]  · · ·  [/dim]")
        console.print()
...
@click.command(
    name="om",
    help="Om's Den — AI coding agent. Run without arguments for interactive mode.",
)
